...
def check_sqllite_script(sitename, env, logpath, hostname, sqlitdbepath, sqlitedbname,
    ...
    try:
        ...
        message_conn_db = f'{sitestarttime}|{site}|SQLITE_DB|ERROR|Failed to connect SQLITE DB on Exception = {excep_conn_db}\r\n'
    ...
    if conn is not None:
        try:
            ...
            message_create_cursor = f'{sitestarttime}|{site}|SQLITE_DB|ERROR|Failed to connect SQLITE DB - Create Cursor on Exception = {excep_create_cursor}\r\n'
    ...
    if conn_c is not None:
        try:
            ...
            message_sql_cmd = f'{sitestarttime}|{site}(SQLITE_DB|ERROR|ERROR: Failed to connect SQLITE DB - Execute SQL Command: {excep_sql_cmd}\r\n'
    ...
    if sqlresult is not None:
        if sqliteexpectedvalueint and sqlliteevaluateoperator is not None:
            try:
                ...
                message_sql_eval = f'{sitestarttime}|{site}|SQLITE_DB|ERROR|Failed to evalute SQL Result: {excep_sql_eval}\r\n'
            ...
            message_compare_failed = f'{sitestarttime}|{site}|SQLITE_DB|ERROR|Result comparision failed due missing expected values or operator in config file'
        ...
        message_comp_failed_no_res = f'{sitestarttime}|{site}|SQLITE_DB|ERROR|SQL result comparision failed due to not obained SQL Result '
    ...
    if sqlcomparision == 'OK':
        message_validation_ok = f'{sitestarttime}|{site}|SQLITE_DB|OK|Condition validation OK - SQL scripts results are in defined conditon: records {sqlresult}\r\n'
        ...
        message_cond_val_failed = f'{sitestarttime}|{site}|SQLITE_DB|ERROR|SQLITE condition validation failed - SQL scripts results are out of defined conditon: records {sqlresult}\r\n'
    ...
    try:
        ...
        message_close_conn_failed = f'{sitestarttime}|{site}|SQLITE_DB|ERROR|Failed to close connection: {excep_db_close_conn}\r\n'
